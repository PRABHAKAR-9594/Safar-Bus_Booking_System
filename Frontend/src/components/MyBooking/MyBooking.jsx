    ...
    export default function MyBooking() {
        ...
        useEffect(() => {
            const fetchBookings = async () => {
                try {
                    const response = await axios.post('http://localhost:8080/myBooking', { userid: userid });
                    ...
                    const updatedResponse = await axios.post('http://localhost:8080/myBooking', { userid: userid });
        ...
        const handleDeleteEmptyBooking = async (bookingId) => {
            try {
                await axios.post("http://localhost:8080/deleteAllticket", { "userid": bookingId });
        ...
        const handleCancelPassenger = async (bookingId, passengerId) => {
            setShowConfirm({
                ...
                onConfirm: async () => {
                    try {
                        await axios.post("http://localhost:8080/deletemybooking", {
                            "_id": passengerId,
                            "bookingid": bookingId
                        });
        ...
        const handleSubmitReview = async (bookingId) => {
            try {
                await axios.post("http://localhost:8080/review", { name: username, review: reviews[bookingId] });
